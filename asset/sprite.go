...
var (
	...
	PlayerCrouchRight1 *ebiten.Image
	PlayerCrouchRight2 *ebiten.Image
	...
	WhiteDownSlashLeft1 *ebiten.Image
	WhiteDownSlashLeft2 *ebiten.Image
	WhiteDownSlashLeft3 *ebiten.Image
	WhiteDownSlashLeft4 *ebiten.Image
	WhiteDownSlashLeft5 *ebiten.Image
	WhiteDownSlashLeft6 *ebiten.Image

	WhiteUpSlashRight1 *ebiten.Image
	WhiteUpSlashRight2 *ebiten.Image
	WhiteUpSlashRight3 *ebiten.Image
	WhiteUpSlashRight4 *ebiten.Image
	WhiteUpSlashRight5 *ebiten.Image
	WhiteUpSlashRight6 *ebiten.Image

	WhiteUpSlashLeft1 *ebiten.Image
	WhiteUpSlashLeft2 *ebiten.Image
	WhiteUpSlashLeft3 *ebiten.Image
	WhiteUpSlashLeft4 *ebiten.Image
	WhiteUpSlashLeft5 *ebiten.Image
	WhiteUpSlashLeft6 *ebiten.Image
...
func LoadSprites() {
	...
	PlayerCrouchRight1 = imageFromBytes(playerCrouch1Png)
	PlayerCrouchRight2 = imageFromBytes(playerCrouch2Png)

	PlayerCrouchLeft1 = flipImageXAxis(PlayerCrouchRight1)
	PlayerCrouchLeft2 = flipImageXAxis(PlayerCrouchRight2)
	...
	WhiteDownSlashLeft1 = rotateImageClockwise(WhiteSlashRight1)
	WhiteDownSlashLeft2 = rotateImageClockwise(WhiteSlashRight2)
	WhiteDownSlashLeft3 = rotateImageClockwise(WhiteSlashRight3)
	WhiteDownSlashLeft4 = rotateImageClockwise(WhiteSlashRight4)
	WhiteDownSlashLeft5 = rotateImageClockwise(WhiteSlashRight5)
	WhiteDownSlashLeft6 = rotateImageClockwise(WhiteSlashRight6)

	WhiteDownSlashRight1 = flipImageXAxis(WhiteDownSlashLeft1)
	WhiteDownSlashRight2 = flipImageXAxis(WhiteDownSlashLeft2)
	WhiteDownSlashRight3 = flipImageXAxis(WhiteDownSlashLeft3)
	WhiteDownSlashRight4 = flipImageXAxis(WhiteDownSlashLeft4)
	WhiteDownSlashRight5 = flipImageXAxis(WhiteDownSlashLeft5)
	WhiteDownSlashRight6 = flipImageXAxis(WhiteDownSlashLeft6)

	WhiteUpSlashRight1 = flipImageYAxis(WhiteDownSlashRight1)
	WhiteUpSlashRight2 = flipImageYAxis(WhiteDownSlashRight2)
	WhiteUpSlashRight3 = flipImageYAxis(WhiteDownSlashRight3)
	WhiteUpSlashRight4 = flipImageYAxis(WhiteDownSlashRight4)
	WhiteUpSlashRight5 = flipImageYAxis(WhiteDownSlashRight5)
	WhiteUpSlashRight6 = flipImageYAxis(WhiteDownSlashRight6)

	WhiteUpSlashLeft1 = flipImageXAxis(WhiteUpSlashRight1)
	WhiteUpSlashLeft2 = flipImageXAxis(WhiteUpSlashRight2)
	WhiteUpSlashLeft3 = flipImageXAxis(WhiteUpSlashRight3)
	WhiteUpSlashLeft4 = flipImageXAxis(WhiteUpSlashRight4)
	WhiteUpSlashLeft5 = flipImageXAxis(WhiteUpSlashRight5)
	WhiteUpSlashLeft6 = flipImageXAxis(WhiteUpSlashRight6)
